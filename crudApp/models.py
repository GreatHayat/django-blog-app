...
class Profile(models.Model):
    ...
    profile_image = models.ImageField(
        upload_to="profile_images/", validators=[validate_file_size])
...
class Post(models.Model):
    ...
    feature_image = models.ImageField(
        upload_to="feature_images/", validators=[validate_file_size])
...
class Comment(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="comment_by")
...
class Reply(models.Model):
    ...
    comment = models.ForeignKey(
        Comment, on_delete=models.CASCADE, related_name="reply_comment")
